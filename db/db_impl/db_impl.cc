...
DBImpl::DBImpl(const DBOptions& options, const std::string& dbname,
  ...
  ROCKS_LOG_INFO(immutable_db_options_.info_log,
                 "NewDBImpl SuperVersionCount %lu", SuperVersion::_in_use.load(std::memory_order_relaxed));
...
DBImpl::~DBImpl() {
  ...
  ROCKS_LOG_INFO(immutable_db_options_.info_log,
                 "DestructDBImpl SuperVersionCount %lu", SuperVersion::_in_use.load(std::memory_order_relaxed));
}
